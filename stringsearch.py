...
def search_and_highlight_text(input_file, output_file, texts_to_search):
    try:
...
if __name__ == "__main__":
    ...
    output_file_path = "outputfile1.xlsx"
    ...
    search_and_highlight_text(input_file_path, output_file_path, texts_to_search)
